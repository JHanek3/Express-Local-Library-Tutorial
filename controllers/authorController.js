...
exports.author_create_post = [
  ...
  body('family_name').trim().isLength({ min: 1}).escape().withMessage('Family name must be specifed.')
...
//Display Author delete for on GET
...
exports.author_update_post = [
  ...
  (req, res, next) => {
    ...
    //Create Author object with sanitized data and the old id
    var author = new Author(
      {
        first_name: req.body.first_name,
        family_name: req.body.family_name,
